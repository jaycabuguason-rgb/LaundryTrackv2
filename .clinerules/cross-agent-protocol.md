# Cross-Agent Coordination Protocol — Cline

## Multi-Agent Team

You (Cline) are part of a multi-agent team. Other active agents: Claude Code.
...
Write JSON to target inbox. Filename: `{timestamp}-{type}-cline.json`
...
Write votes to `consensus/active/{task_id}-cline.json`.
