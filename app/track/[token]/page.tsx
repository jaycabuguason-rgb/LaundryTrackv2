    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(139,92,246,0.08),_transparent_32%),linear-gradient(180deg,var(--background)_0%,hsl(35,28%,92%)_100%)] dark:bg-background px-4 py-8 text-foreground">
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        {loyaltyRecord ? (
          ...
          <section className="rounded-3xl border border-primary/20 bg-primary/5 p-5 shadow-sm text-center space-y-2">
            <div className="inline-flex items-center justify-center w-10 h-10 rounded-2xl bg-primary/10 text-primary mb-1">
              <Sparkles className="w-5 h-5" />
            </div>
            <h3 className="text-sm font-bold text-foreground">Earn Free Laundries With Every Wash!</h3>
